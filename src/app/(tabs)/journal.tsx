...
const styles = StyleSheet.create({
  feed: { gap: spacing.lg, marginTop: spacing.xl }, authorRow: { alignItems: "center", flexDirection: "row" }, avatar: { alignItems: "center", backgroundColor: colors.coral, borderRadius: radius.pill, height: 38, justifyContent: "center", width: 38 }, lisaAvatar: { backgroundColor: colors.violet }, avatarText: { color: colors.white, fontWeight: "700" },

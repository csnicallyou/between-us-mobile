...
function BottomFade({ dark }: { dark: boolean }) { return <Svg height={98} pointerEvents="none" style={styles.fade} width="100%"><Defs><LinearGradient id="bottomFade" x1="0" x2="0" y1="0" y2="1"><Stop offset="0" stopColor={dark ? "#070707" : "#EEF1F5"} stopOpacity="0"/><Stop offset={0.72} stopColor={dark ? "#070707" : "#EEF1F5"} stopOpacity={dark ? 0.18 : 0.08}/><Stop offset="1" stopColor={dark ? "#070707" : "#EEF1F5"} stopOpacity={dark ? 0.32 : 0.14}/></LinearGradient></Defs><Rect fill="url(#bottomFade)" height="100%" width="100%"/></Svg>; }
